...
#    midas_tst_dataset= midas_data(test_path)
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        if training_dataset.image_weights:
        ...
        for i, (yolo_data, midas_data) in pbar:  # batch -------------------------------------------------------------
            ...
            depth_max = ddepth_prediction.max()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='/content/YoloV3/data/smalcoco/labels/train2014', help='*.data path')
